...
import { pageTermsSx } from 'pages/PageTerms/PageTermsStyles';

export default class PageTerms extends Component {
  componentDidMount() {
    // Web analytics
    Mixpanel.track('Terms_Page', {});
    window.scrollTo(0, 0);
  }
  ...
  render() {
    return (
      <Container style={{ backgroundColor: '#f8f8f8' }}>
        <div className="page-terms" sx={pageTermsSx}>
          ...
          <div className="terms-body">
            ...
            <div>
              This website is operated by Datamatch. Throughout the site, the
              terms “Datamatch”, “we”, “us” and “our” refer to Datamatch.
              Datamatch offers this website, including all information, tools
            ...
            <h4>SECTION 1 - ONLINE WEBSITE TERMS</h4>
            <div>
            ...
            <div>
              You agree to create only one account for each yearly iteration of
              Datamatch.
            </div>
            <div>
            ...
            <h4>SECTION 5 - OPTIONAL TOOLS</h4>
            <div>
            ...
            <h4>SECTION 7 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4>
            <div>
              If, at our request, you send certain specific submissions (for
              example feedback suggestions or contest entries) or without a
              request from us you send creative ideas, suggestions, proposals,
              plans, or other materials, whether online, by email, by postal
              mail, or otherwise (collectively, 'comments'), you agree that we
            ...
            <h4>SECTION 8 - PERSONAL INFORMATION</h4>
            <div>
              Your submission of personal information through the store is
              governed by our <Link to="/app/privacy">Privacy Policy</Link>.
            </div>
            <h4>SECTION 9 - ERRORS, INACCURACIES AND OMISSIONS</h4>
            <div>
            ...
            <div>
              You are prohibited from redeeming more than two free dates for
              your account.
            </div>
            <div>
              We reserve the right to terminate your use of the Service or any
              related website for violating any of the prohibited uses. You may
              be banned from future iterations of Datamatch.
            </div>
            <h4>
            ...
            <div>
              In no case shall Datamatch, our directors, officers, employees,
            ...
            <div>
              You agree to indemnify, defend and hold harmless Datamatch and our
            ...
            <h4>SECTION 16 - GOVERNING LAW</h4>
            <div>
              These Terms of Service and any separate agreements whereby we
              provide you Services shall be governed by and construed in
              accordance with the laws of 59 Shepard St, Cambridge, MA 02138,
              United States.
            </div>
            <h4>SECTION 17 - CHANGES TO TERMS OF SERVICE</h4>
            <div>
