...
class MatchesProfile extends Component {
  constructor(props) {
    super(props);
  ...
  initialize(data) {
    ...
    this.graphMatchProb(matchProfile, data, 'profile', width, height - buffer);
  }
  ...
  graphMatchProb(svg, file, demo, height, width) {
    ...
    svg.append('g').call(d3.axisTop(x)).attr('font-size', '14px');
...
export default firebaseConnect()(MatchesProfile);
